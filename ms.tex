...
\title{Calibrating the Dusty Cosmos: \textit{Hubble} H$\alpha$/Paschen$\beta$ Images of Nearby Galaxies}
...
\section{The H$\alpha$/Paschen$\beta$ Sample} \label{sec:sample}

\section{Data Processing} \label{sec:data}

\subsection{Continuum Subtraction} \label{sec:continuum}
